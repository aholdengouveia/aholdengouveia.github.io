...
\hypersetup{
    colorlinks=false,
    pdfborder={0 0 0},
    pdftitle={SQL Challenges Lab},
    pdfauthor={Adrianna Holden-Gouveia},
    pdfsubject={Introduction to Data - Lab Assignment},
    pdflang={en-US},
    pdfkeywords={SQL, challenges, HackerRank, problem solving, queries}
...
Link: \href{https://aholdengouveia.name/IntroData/labs/dbsql3.html}{\textbf{https://aholdengouveia.name/IntroData/labs/dbsql3.html}}
...
Link: \href{https://www.aholdengouveia.name/IntroData/sql3.html}{\textbf{https://www.aholdengouveia.name/IntroData/sql3.html}}

The challenges are here: Link: \href{https://www.hackerrank.com/domains/sql}{\textbf{https://www.hackerrank.com/domains/sql}} You will need to register, but it's a free site. 
