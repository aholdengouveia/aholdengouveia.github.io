...
\hypersetup{
    colorlinks=false,
    pdfborder={0 0 0},
    pdftitle={Introduction to Databases Lab},
    pdfauthor={Adrianna Holden-Gouveia},
    pdfsubject={Introduction to Data - Lab Assignment},
    pdflang={en-US},
    pdfkeywords={databases, spreadsheets, LibreOffice Base, data management}
...
Link: \href{https://aholdengouveia.name/IntroData/labs/introdatabases.html}{\textbf{https://aholdengouveia.name/IntroData/labs/introdatabases.html}}
...
Link: \href{https://www.aholdengouveia.name/IntroData/introdatabases.html}{\textbf{https://www.aholdengouveia.name/IntroData/introdatabases.html}}

For this lab you'll be using LibreOffice Base.  The documentation can be found at Link: \href{https://books.libreoffice.org/en/BG73/BG7301-IntroductionToBase.html#toc26}{\textbf{https://books.libreoffice.org/en/BG73/BG7301-IntroductionToBase.html#toc26}}
