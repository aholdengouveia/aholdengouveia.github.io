...
\hypersetup{
    colorlinks=false,
    pdfborder={0 0 0},
    pdftitle={UI/UX and Uses of Data Lab},
    pdfauthor={Adrianna Holden-Gouveia},
    pdfsubject={Introduction to Data - Lab Assignment},
    pdflang={en-US},
    pdfkeywords={UI/UX, user interface, user experience, data ethics, design critique}
...
Link: \href{https://aholdengouveia.name/IntroData/labs/usesandabusesofdata.html}{\textbf{https://aholdengouveia.name/IntroData/labs/usesandabusesofdata.html}}
...
Link: \href{https://www.aholdengouveia.name/IntroData/usesofdata.html}{\textbf{https://www.aholdengouveia.name/IntroData/usesofdata.html}}

Examples of bad UI/UX
\begin{itemize}
    \item BadUI battles on reddit Link: \href{https://www.reddit.com/r/badUIbattles/}{\textbf{https://www.reddit.com/r/badUIbattles/}}
    \item Bad UI examples Link: \href{https://goulartnogueira.github.io/BadUI/}{\textbf{https://goulartnogueira.github.io/BadUI/}}
\end{itemize}    

Examples of good UI/UX
\begin{itemize}
    \item Webby Awards Link: \href{https://www.webbyawards.com/}{\textbf{https://www.webbyawards.com/}}
    \item UX design awards Link: \href{https://ux-design-awards.com/}{\textbf{https://ux-design-awards.com/}}
\end{itemize}


\subsection*{Answer the following questions}
Each of the above 4 websites above showcases some of the best and the worst of UI/UX. Going through the entries/comments/winners/submissions please answer the following questions using the 10 point checklist and feedback pointers from Link: \href{https://designlab.com/blog/design-critique-checklist-for-ux-designers#ten}{\textbf{https://designlab.com/blog/design-critique-checklist-for-ux-designers#ten}} If the point isn't relevant to your question, you may include an explanation of why instead. For example, if you want to critique a physical product, it may not have a navigation or mobile design to give feedback on, and it's ok to explain that. 
