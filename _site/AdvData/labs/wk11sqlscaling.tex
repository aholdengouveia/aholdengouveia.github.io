...
Link: \href{https://aholdengouveia.name/AdvData/labs/wk11sqlscaling.html}{\textbf{https://aholdengouveia.name/AdvData/labs/wk11sqlscaling.html}}
...
Link: \href{https://www.aholdengouveia.name/AdvData/SQLscaling.html}{\textbf{https://www.aholdengouveia.name/AdvData/SQLscaling.html}}

\subsection*{SQL Challenges HackerRank}

    \begin{itemize}
        \item From Link: \href{https://www.hackerrank.com}{\textbf{https://www.hackerrank.com}} You'll be doing 3 challenges that are listed as Medium difficulty or higher.  Make sure you pick NEW challenges. Take screenshots of each solution making sure to include your name and the term in each screenshot.
...
\subsection*{SQL Challenges}
    ...
    From Link: \href{https://8weeksqlchallenge.com/}{\textbf{https://8weeksqlchallenge.com/}} you will be doing 2 case studies.  You can either use the embedded option in the website, or put the data into another place such as SQL Sandbox or a locally hosted database
\begin{itemize}
