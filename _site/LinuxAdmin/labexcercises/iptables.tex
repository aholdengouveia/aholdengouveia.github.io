...
Link: \href{https://aholdengouveia.name/LinuxAdmin/labexcercises/iptables.html}{\textbf{https://aholdengouveia.name/LinuxAdmin/labexcercises/iptables.html}}

The HTML version provides enhanced accessibility features including keyboard navigation, screen reader support, responsive design, dark mode support, and high contrast options.

\section*{Objectives:}
\begin{itemize}
    \item The objective of this lab is to introduce students to iptables, Linux's built-in firewall and packet filtering system, which is critical for network security and server protection. Through hands-on exercises, students will learn to configure firewall rules for common services, control network traffic through port management and forwarding, block or allow specific hosts, and understand strategies for preventing network attacks such as DDOS—essential skills for securing Linux servers in production environments.
\end{itemize}
\section*{Complete the following problems}

References, a video, a PowerPoint and some notes are available at my website
Link: \href{https://www.aholdengouveia.name/LinuxAdmin/iptables.html}{\textbf{https://www.aholdengouveia.name/LinuxAdmin/iptables.html}}
