...
\url{https://aholdengouveia.name/IntroLinux/labs/aliasesandothers.html}
...
Adrianna's video on how to use tar \url {https://youtu.be/x0EK6PmKRCU}  


References, a video, a PowerPoint and some notes are available at my website
\url {https://www.aholdengouveia.name/IntroLinux/aliasesandothers.html}

\subsection*{Aliases}
 Reference: \url {http://linuxreviews.org/quicktips/alias/}
...
This part of the lab is about changing your command prompt. We will be using Environmental Variables to do this.
 ...
 Reference: 
 \url{http://maketecheasier.com/8-useful-and-interesting-bash-prompts/2009/09/04}

\url{https://www.maketecheasier.com/more-useful-and-interesting-bash-prompts/}
