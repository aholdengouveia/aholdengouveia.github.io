...
Link: \href{https://aholdengouveia.name/IntroLinux/labs/cmdsandwildcards.html}{\textbf{https://aholdengouveia.name/IntroLinux/labs/cmdsandwildcards.html}}
...
Link: \href{https://www.aholdengouveia.name/IntroLinux/cmdsandwildcards.html}{\textbf{https://www.aholdengouveia.name/IntroLinux/cmdsandwildcards.html}}
...
\begin{itemize}
    ...
    \item For each of the problems you should start with ls and then figure out the pattern needed to show the requested information, then pick 1 of them to try with find instead.  \item Demo of how to use ls is in the Linux FAQ videos Link: \href{https://youtube.com/playlist?list=PLQOmuLC45eoQlIMH7oCNL6yFP7kWQubBo&si=R1SFWzEPHDDo-VBJ}{\textbf{https://youtube.com/playlist?list=PLQOmuLC45eoQlIMH7oCNL6yFP7kWQubBo&si=R1SFWzEPHDDo-VBJ}}
