...
\url{https://aholdengouveia.name/IntroLinux/labs/commoncommands.html}
...
\url {https://www.aholdengouveia.name/IntroLinux/commoncommands.html}
...
\subsection*{Steps for the lab}
    \begin{enumerate}
        \item Use puTTY or SSH to connect to the server (or do this on you own Linux system)  If you need help using SSH or SCP I made a video on how to do that  on my YouTube channel.  SCP?  SSH-ut the front door! \url{https://youtu.be/w3yOQFZJMTo}
