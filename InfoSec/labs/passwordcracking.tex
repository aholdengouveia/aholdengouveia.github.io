...
\hypersetup{
    colorlinks=false,
    pdfborder={0 0 0},
    pdftitle={Password Cracking Lab},
...
Link: \href{https://aholdengouveia.name/InfoSec/labs/passwordcracking.html}{\textbf{https://aholdengouveia.name/InfoSec/labs/passwordcracking.html}}
...
First we're going to practice using Kali on a list of passwords I'm giving you, it's called "passwords.zip" and contains a file called "crack-these-please"
    \begin{enumerate}
        ...
        \item John the Ripper is a command line tool.  Check under "usage example" to see what this looks like when it's run Link: \href{http://tools.kali.org/password-attacks/john}{\textbf{http://tools.kali.org/password-attacks/john}} If you run into any problems or need to troubleshoot go to John's homepage at Link: \href{http://www.openwall.com/john/}{\textbf{http://www.openwall.com/john/}}
