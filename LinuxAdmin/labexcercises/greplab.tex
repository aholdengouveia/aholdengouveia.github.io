...
\hypersetup{
    ...
    pdflang={en-US},
    pdfkeywords={grep, pattern matching, text search, Linux, regular expressions}
...
Link: \href{https://aholdengouveia.name/LinuxAdmin/labexcercises/greplab.html}{\textbf{https://aholdengouveia.name/LinuxAdmin/labexcercises/greplab.html}}

The HTML version provides enhanced accessibility features including keyboard navigation, screen reader support, responsive design, dark mode support, and high contrast options.

\section*{Objectives:}
\begin{itemize}
    \item The objective of this lab is to introduce students to grep, a fundamental Linux command-line tool for searching and filtering text using pattern matching and regular expressions. Through hands-on exercises, students will learn to construct effective search patterns for finding specific information in files, including working with literal strings, character classes, anchors, and negation—essential skills for log analysis, data extraction, and system troubleshooting.
\end{itemize}
\section*{Complete the following problems}

References, a video and some notes are available at my website

Link: \href{https://www.aholdengouveia.name/LinuxAdmin/Grep.html}{\textbf{https://www.aholdengouveia.name/LinuxAdmin/Grep.html}}
