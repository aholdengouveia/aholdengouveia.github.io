...
\hypersetup{
    colorlinks=false,
    pdfborder={0 0 0},
    pdftitle={Scripting for Server Security Part 2},
    pdfauthor={Adrianna Holden-Gouveia},
    pdfsubject={Linux Administration - Lab Assignment},
    pdflang={en-US},
    pdfkeywords={server security, troubleshooting, scripting, cron jobs, emergency boot}
...
Link: \href{https://aholdengouveia.name/LinuxAdmin/labexcercises/securitypt2.html}{\textbf{https://aholdengouveia.name/LinuxAdmin/labexcercises/securitypt2.html}}

The HTML version provides enhanced accessibility features including keyboard navigation, screen reader support, responsive design, dark mode support, and high contrast options.

\section*{Objectives:}
\begin{itemize}
    \item The objective of this lab is to develop students' systematic troubleshooting skills and security automation capabilities through hands-on problem-solving exercises. Students will diagnose and resolve deliberately introduced server issues, transform troubleshooting processes into automated scripts, implement scheduled security monitoring using cron jobs, and master emergency boot procedures—building the diagnostic expertise and proactive security practices essential for maintaining robust and resilient Linux server environments.
\end{itemize}
